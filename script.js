...
// Updated function to handle subCategoryPart click
function clickSubCategoryPart(index, isContinuous = false) {
  let content;

  if (isContinuous) {
    // If it's a continuous subcategory, use the subCategoryPartContinuousContent array
    ...
    // Otherwise, use the original subCategoryContent array
