...
const rightDisplayContent = {
  ...
  menu3: [
    { title: "Specify", heading: "Defining Requirements", subHeading: "Define the functional and non-functional requirements.", description: "The specification phase of the project involves capturing the requirements for the software, identifying use-cases and assessing risk.", videoSrc: "Synthesia_Videos/Specify_ Requirements.mp4" },
